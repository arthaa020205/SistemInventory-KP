...
<title>
    Surat Jalan {{ $barangKeluar->kode_transaksi }}
</title>
...
<div style="margin-top:15px; padding:9px 12px; border:1px solid #ddd;">
    <strong>Total Jenis Barang:</strong>
    {{ $barangKeluar->details->count() }} jenis
</div>
...
<div class="footer">
    ...
    Dokumen ini merupakan surat jalan pengiriman barang
    CV Cahaya Khanza Plastik.
